...
class ThirdPaymentViewBody extends StatelessWidget {
  const ThirdPaymentViewBody({super.key});
      ...
      slivers: [
        ...
        SliverToBoxAdapter(
          child: CustomContainerPaymentViewBody(
              title: AppStrings.donationThree,
              subTitle: AppStrings.paymentDonationDetailsThree),
        )
      ],
    );
  }
